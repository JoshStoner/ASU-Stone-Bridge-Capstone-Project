...
class Database
{
    ...
    func addWell(Category: String, YesOrNo: String, comment: String)
    {
        
        
        let insertWell = self.InspectionDescription.insert(self.Category <- Category, self.YesOrNo <- YesOrNo, self.comment <- comment)
        do{
